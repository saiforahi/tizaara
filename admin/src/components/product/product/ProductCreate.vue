        ...
        <form-wizard @on-complete="formSubmit" title="Add New Products / Service" subtitle="Insert product/Service information"
          ...
          <tab-content title="Product/Service Information" icon="ti-package"
            ...
            <div class="card" style="background-color: #dae2ed;">
              ...
              <div class="card-footer" style="font-size: 13px">
                {{$t("message.product_creat.categories_selected")}}
            ...
            <CInput label="Product/Service Name* :" v-model="$v.form.name.$model"
                    ...
                    :invalidFeedback="!$v.form.name.required? this.$t('message.product_creat.product_name_required'): $v.form.name.maxLength?'': this.$t('message.product_creat.product_name_character') "
            ...
            <CTextarea label="Product/Service sort description : " v-model="$v.form.sort_desc.$model"
                       ...
                       :invalidFeedback="$v.form.sort_desc.maxLength?'': this.$t('message.product_creat.product_sort_description_character')"
                       :isValid="validateState('sort_desc')"
                       rows="3"/>
            <div role="group" class="form-group form-row">
              <label class="col-form-label col-sm-3"> {{$t('message.product_creat.select_brand')}} </label>
              <div class="col-sm-9">
            ...
            <div role="group" class="form-group form-row">
              <label class="col-form-label col-sm-3"> {{$t('message.product_creat.select_unit')}} </label>
              <div class="col-sm-9">
            ...
            <b-row sm="12" v-for="(property, k) in form.properties" :key="k">
              <b-col sm="3">
              ...
              <b-col sm="1">
                <b-form-checkbox color="secondary" v-model="property.is_show"></b-form-checkbox>
              </b-col>
              <b-col sm="1">
            ...
            <p class="text-info font-weight-bold my-2" style="font-size: 12px;cursor: pointer"
              ...
              {{$t('message.product_creat.add_more_property')}}</p>
          ...
          <tab-content title="Product/Service Images" icon="ti-image"
            ...
            <b-alert
              ...
              {{$t('message.product_creat.insert_multiple_product_thumbnail_image')}}
            </b-alert>
            <CRow class="my-3">
              <CCol md="6">
                <div role="group" class="d-flex justify-content-center">
                  <div class=""><label>{{$t('message.product_creat.select_product_service_images')}}</label>
              ...
              <CCol md="6">
                <div role="group" class="d-flex justify-content-center">
                  <div class=""><label>{{$t('message.product_creat.select_thumbnail_image')}}</label>
                    <vue-upload-multiple-image
            ...
            <CRow class="my-5">
              <CCol md="6">
                <div role="group" class="d-flex justify-content-center">
                  <div class=""><label>{{$t('message.product_creat.select_featured_images')}}</label>
                    <vue-upload-multiple-image
              ...
              <CCol md="6">
                <div role="group" class="d-flex justify-content-center">
                  <div class=""><label>{{$t('message.product_creat.select_flash_deal_image')}}</label>
                    <vue-upload-multiple-image
                  ...
                  <template #append>
                    <CButton type="button" color="primary" @click="productVideo">
                      <font-awesome-icon icon="search"/>
                       {{$t('message.product_creat.search')}}
                    </CButton>
                  </template>
                </CInput>
              </CCol>
          ...
          <tab-content title="Product/Service Price" icon="ti-money" :before-change="validateThirdStep">
             {{$t('message.product_creat.product_service_attribute')}}
            <hr>
            <c-row>
              <CCol col="6" sm="4" md="2" class="mb-3 mb-xl-0">
                <CButton block color="dark" disabled>
                  {{$t('message.product_creat.colour')}}
                </CButton>
              </CCol>
              ...
              <CCol col="6" sm="4" md="3" class="mb-3 mb-xl-0">
                <b-form-checkbox
                    ...
                    value="1"
                    unchecked-value="0">
                  {{$t('message.product_creat.colour_with_image')}}
                </b-form-checkbox>
              </CCol>
            </c-row>
            ...
            <CRow class="mt-3">
              <CCol col="6" sm="4" md="2" class="mb-3 mb-xl-0">
                <CButton block color="dark" disabled>
                  {{$t('message.product_creat.attributes')}}
                </CButton>
              </CCol>
              <CCol col="6" sm="4" md="6" class="mb-3 mb-xl-0">
            ...
            <p class="text-info">{{$t('message.product_creat.note')}}</p>
            ...
            <br><br><br>{{$t('message.product_creat.product_service_tax_offer_discount')}}
            <hr>
            <CRow>
            ...
            <CRow class="mb-3">
              <CCol col="6" sm="4" md="3" class="mb-3 mb-xl-0">
                {{$t('message.product_creat.order_quantity_limit')}}
              </CCol>
...
<!--            <CRow>
                ...
                <b-form-group label="Select Currency*:"
                  ...
                  <b-form-select v-model="$v.form.currency_id.$model" :options="Object.values(currencyList)"
                    ...
                    <template v-slot:first>
                      <b-form-select-option value="" disabled>{{$t('message.product_creat.please_select_currency')}}</b-form-select-option>
                    </template>
                  </b-form-select>
                  <b-form-invalid-feedback v-if="!$v.form.currency_id.required">
                    {{$t('message.product_creat.currency_required')}}
            ...
            <CRow class="my-4">
              <CCol col="6" sm="4" md="12" class="mb-3 mb-xl-0">
                <b-form-checkbox
                  ...
                  {{$t('message.product_creat.enable_discount')}}
                </b-form-checkbox>
              </CCol>
            </CRow>
            <CRow v-if="form.discountMethod == 1" class="my-4">
              <CCol col="12" sm="12" md="8" class="mb-3 mb-xl-0">
                <p class="text-right text-info font-weight-bold my-0" style="font-size: 12px;cursor: pointer"
                  ...
                  {{$t('message.product_creat.add_volume_tier')}}</p>
                <table class="table table-bordered">
                  <thead>
                  <tr>
                    <th>{{$t('message.product_creat.minimum_quantity')}}</th>
                    <th></th>
                    <th>{{$t('message.product_creat.additional_off')}}</th>
                    <th>{{$t('message.product_creat.action')}}</th>
                  </tr>
                  </thead>
                  <tbody>
            ...
            <br><br><br>{{$t('message.product_creat.product_price_stock')}}
            <hr>
            <CRow class="mt-4">
              <CCol col="12">
                <b-form-group>
                  <b-form-radio-group id="radio-group-2" v-model="form.priceType" name="radio-sub-component">
                    <b-form-radio value="0">{{$t('message.product_creat.simple_product')}}</b-form-radio>
                    <b-form-radio value="1">{{$t('message.product_creat.variable_product')}}</b-form-radio>
                    <b-form-radio value="2">{{$t('message.product_creat.volume_tier_pricing')}}</b-form-radio>
                  </b-form-radio-group>
                </b-form-group>
              </CCol>
            </CRow>
            <CRow class="mb-4">
              <CCol col="6" sm="4" md="12" class="mb-3 mb-xl-0">
                <b-form-checkbox
                    ...
                    value="1"
                    unchecked-value="0">
                  {{$t('message.product_creat.stock_management')}}
                </b-form-checkbox>
              </CCol>
            </CRow>
            ...
            <table v-if="form.priceType == 1" class="table table-bordered">
              <thead>
              <tr>
                <th>{{$t('message.product_creat.variant')}}</th>
                <th>{{$t('message.product_creat.variant_price')}}</th>
                <th v-if="form.stockManagement == 1">{{$t('message.product_creat.quantity')}}</th>
              </tr>
              </thead>
              <tbody>
            ...
            <CRow v-if="form.priceType == 2" class="my-4">
              <CCol col="12" sm="12" md="8" class="mb-3 mb-xl-0">
                ...
                <table class="table table-bordered">
                  ...
                  <tr>
                    <th>{{$t('message.product_creat.minimum_quantity')}}</th>
                    <th>{{$t('message.product_creat.maximum_muantity')}}</th>
                    <th>{{$t('message.product_creat.unit_price')}}</th>
                    <th>{{$t('message.product_creat.action')}}</th>
                  </tr>
                  </thead>
                  <tbody>
          ...
          <tab-content title="Product/Service Description" :before-change="validateForthStep" icon="ti-receipt">
            {{$t('message.product_creat.product_description')}}
            <hr>
            <CInput label="Product Weight :" v-model="$v.form.weight.$model"
                    horizontal placeholder="Enter product weight"
                    :invalidFeedback="$v.form.weight.maxLength?'': this.$t('message.product_creat.product_weight_character') "
                    :isValid="validateState('weight')"/>
            <div role="group" class="form-group form-row">
              <label class="col-form-label col-sm-3"> {{$t('message.product_creat.tags')}} </label>
              <div class="col-sm-9">
                <vue-tags-input
            ...
            <div role="group" class="form-group form-row">
              <label class="col-form-label col-sm-3">{{$t('message.product_creat.dimension')}} </label>
              <div class="col-sm-3">
                <CInput v-model="$v.form.length.$model"
                        placeholder="Length"
                        :invalidFeedback="$v.form.length.maxLength?'': this.$t('message.product_creat.not_more_character') "
                        :isValid="validateState('length')"/>
              </div>
              <div class="col-sm-3">
                <CInput v-model="$v.form.width.$model"
                        placeholder="Width"
                        :invalidFeedback="$v.form.width.maxLength?'': this.$t('message.product_creat.not_more_character') "
                        :isValid="validateState('width')"/>
              </div>
              <div class="col-sm-3">
                <CInput v-model="$v.form.height.$model"
                        placeholder="Height"
                        :invalidFeedback="$v.form.height.maxLength?'': this.$t('message.product_creat.not_more_character') "
                        :isValid="validateState('height')"/>
              </div>
            </div>
            <CRow form class="form-group">
              <CCol sm="3">
                {{$t('message.product_creat.product_type')}}
              </CCol>
              <CCol sm="9">
                <b-form-group>
                  <b-form-radio-group id="radio-group-1" v-model="form.product_type" name="radio-sub">
                    <b-form-radio value="New">{{$t('message.product_creat.new')}}</b-form-radio>
                    <b-form-radio value="Used">{{$t('message.product_creat.used')}}</b-form-radio>
                  </b-form-radio-group>
                </b-form-group>
              </CCol>
            </CRow>
          ...
          <tab-content title="Product/Service Shipping and SEO" icon="ti-truck">
            {{$t('message.product_creat.product_shipping_cost')}}
            <hr>
            <loading :active.sync="visible" :can-cancel="true"></loading>
            <CRow>
              <CCol col="6" sm="4" md="2" class="mb-3 mb-xl-0">
                {{$t('message.product_creat.free_shipping')}}
              </CCol>
              <CCol col="6" sm="4" md="2" class="mb-3 mb-xl-0">
            ...
            <br><br><br>{{$t('message.product_creat.seo_meta_tags')}}
            <hr>
            <CRow>
            ...
            <CRow class="mb-5">
              <CCol col="6" sm="4" md="2" class="mb-3 mb-xl-0">
                {{$t('message.product_creat.meta_image')}}
              </CCol>
              <CCol col="6" sm="4" md="2" class="mb-3 mb-xl-0">
                <vue-upload-multiple-image
...
export default {
  ...
  data() {
    return {
      ...
      form: new Form({
        ...
        currency_id: 1,//default 1that means BDT
        tax: null,
        tax_type: 'Flat',
        discount: null,
        discount_type: 'Flat',
  ...
  methods: {
    ...
    formSubmit() {
      ...
      if (!this.cat_valid) {
        swal.fire(this.$t("message.common.invalid"), this.$t("message.common.category_not_selected"), 'warning')
        return false;
      }
      this.visible = true;
      this.show = true;
      ...
      this.form.post('product')
          .then((e) => {
            ...
            this.show = false;
            swal.fire({
              title: this.$t("message.product_creat.product_upload_successfully"),
              text: this.$t("message.product_creat.product_upload_successfully"),
              icon: 'success',
          ...
          .catch((error) => {
            ...
            if (data.status === 422) {
              ...
              swal.fire({
                title: this.$t("message.common.error"),
                html: mainData,
                type: 'error'
              })
            } else {
              swal.fire({
                ...
                text: this.$t("message.product_creat.input_data_problem"),
                icon: 'warning',
                showCancelButton: false,
                confirmButtonColor: '#3085d6',
                confirmButtonText: 'Ok'
