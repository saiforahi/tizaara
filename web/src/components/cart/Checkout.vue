            ...
            <div class="row">
              <div class="col-md-4 order-md-2 mb-4 mt-4">
                ...
                <ul class="list-group mb-3 sticky-top">
                  ...
                  >
                    <div>
                      <span class="my-0">{{ cart.product.name }}</span
                      ><br />
                      <span class="text-muted">
                        <strong>{{
                          cart.quantity + " X " + cart.discount_price
                        }}</strong></span
                      >
                    </div>
                    <h6 class="text-muted">
                      {{ cart.discount_price * cart.quantity }}
                    </h6>
                  </li>
                  <li
                    class="
                ...
                >
                    ...
                    <div class="col-md-6 my-2">
                      ...
                      >
                        ...
                        <b-input-group size="sm">
                          ...
                          <b-form-invalid-feedback
                            v-if="!$v.form.first_name.maxLength"
                          >
                    ...
                    <div class="col-md-6 my-2">
                      ...
                      >
                        ...
                        <b-input-group size="sm">
                          ...
                          ></b-form-input>
                          <b-form-invalid-feedback
                            v-if="!$v.form.address_l1.required"
                          >
                    ...
                    <div class="col-md-4 my-2">
                      ...
                      >
                        ...
                        <b-input-group size="sm">
                          ...
                          <b-form-invalid-feedback
                            v-if="!$v.form.country_id.required"
                          >
                    ...
                    <div class="col-md-4 my-2">
                      ...
                      >
                        ...
                        <b-input-group size="sm">
                          ...
                          <b-form-invalid-feedback
                            v-if="!$v.form.division_id.required"
                          >
                  ...
                  <div class="custom-control custom-checkbox">
                    <input
                      ...
                      v-model="shipping_a_s_a_b_address"
                      :checked="shipping_a_s_a_b_address"
                      id="same-address"
                    />
                  ...
                  <div v-if="!shipping_a_s_a_b_address">
                    ...
                    <div class="row">
                      <div class="col-md-6 my-2">
                        ...
                        >
                          ...
                          <b-input-group size="sm">
                            ...
                            <b-form-input
                              v-model="$v.form.s_first_name.$model"
                              type="text"
                              id="export_started_year"
                              size="sm"
                              :state="validateState('s_first_name')"
                              :placeholder="$t('message.checkout.first_name')"
                            ></b-form-input>
                            <b-form-invalid-feedback
                              v-if="!$v.form.s_first_name.required"
                            >
                              {{ $t("message.checkout.first_name_required") }}
                            </b-form-invalid-feedback>
                            <b-form-invalid-feedback
                              v-if="!$v.form.s_first_name.maxLength"
                            >
                              {{ $t("message.checkout.maximum_char_is_191") }}
                            </b-form-invalid-feedback>
                          </b-input-group>
                      ...
                      <div class="col-md-6 my-2">
                        ...
                        >
                          ...
                          <b-input-group size="sm">
                            ...
                            <b-form-input
                              v-model="$v.form.s_last_name.$model"
                              type="text"
                              id="export_started_year"
                              size="sm"
                              :state="validateState('s_last_name')"
                              :placeholder="$t('message.checkout.last_name')"
                            ></b-form-input>
                            <b-form-invalid-feedback
                              v-if="!$v.form.s_last_name.required"
                            >
                              {{ $t("message.checkout.last_name_required") }}
                            </b-form-invalid-feedback>
                            <b-form-invalid-feedback
                              v-if="!$v.form.s_last_name.maxLength"
                            >
                              {{ $t("message.checkout.maximum_char_is_191") }}
                            </b-form-invalid-feedback>
                          </b-input-group>
                      ...
                      <div class="col-md-6 my-2">
                        ...
                        >
                          ...
                          <b-input-group size="sm">
                            ...
                            <b-form-input
                              v-model="$v.form.s_email.$model"
                              type="email"
                              id="email"
                              size="sm"
                              :state="validateState('s_email')"
                              :placeholder="$t('message.checkout.email')"
                            ></b-form-input>
                            <b-form-invalid-feedback
                              v-if="!$v.form.s_email.required"
                            >
                              {{ $t("message.checkout.email_required") }}
                            </b-form-invalid-feedback>
                            <b-form-invalid-feedback
                              v-else-if="!$v.form.s_email.maxLength"
                            >
                              {{ $t("message.checkout.maximum_char_is_191") }}
                            </b-form-invalid-feedback>
                          </b-input-group>
                      ...
                      <div class="col-md-6 my-2">
                        ...
                        >
                          <label>{{
                            $t("message.checkout.phone_number")
                          }}</label>
                          <b-input-group size="sm">
                            <b-input-group-prepend is-text>
                              <i class="fas fa-vote-yea"></i>
                            ...
                            <b-form-input
                              v-model="$v.form.s_phone_number.$model"
                              id="email"
                              size="sm"
                              :state="validateState('s_phone_number')"
                              :placeholder="$t('message.checkout.phone_number')"
                            ></b-form-input>
                            <b-form-invalid-feedback
                              v-if="!$v.form.s_phone_number.required"
                            >
                              {{ $t("message.checkout.phone_number_required") }}
                            </b-form-invalid-feedback>
                            <b-form-invalid-feedback
                              v-else-if="!$v.form.s_phone_number.maxLength"
                            >
                              {{
                                $t(
                                  "message.checkout.phone_number_max_char_over"
                                )
                              }}
                            </b-form-invalid-feedback>
                          </b-input-group>
                      ...
                      <div class="col-md-6 my-2">
                        ...
                        >
                          ...
                          <b-input-group size="sm">
                            ...
                            <b-form-input
                              v-model="$v.form.s_address_l1.$model"
                              id="email"
                              size="sm"
                              :state="validateState('s_address_l1')"
                              :placeholder="$t('message.checkout.address_l1')"
                            ></b-form-input>
                            <b-form-invalid-feedback
                              v-if="!$v.form.s_address_l1.required"
                            >
                              {{ $t("message.checkout.address_l1_required") }}
                            </b-form-invalid-feedback>
                            <b-form-invalid-feedback
                              v-else-if="!$v.form.s_address_l1.maxLength"
                            >
                              {{ $t("message.checkout.maximum_char_is_191") }}
                            </b-form-invalid-feedback>
                          </b-input-group>
                      ...
                      <div class="col-md-4 my-2">
                        ...
                        >
                          ...
                          <b-input-group size="sm">
                            ...
                            <b-form-select
                              :options="countryList"
                              @change="dropChange2('country')"
                              v-model="$v.form.s_country_id.$model"
                              :state="validateState('s_country_id')"
                              value-field="id"
                              size="sm"
                              text-field="name"
                            >
                            ...
                            <b-form-invalid-feedback
                              v-if="!$v.form.s_country_id.required"
                            >
                              {{ $t("message.checkout.country_required") }}
                            </b-form-invalid-feedback>
                          </b-input-group>
                      ...
                      <div class="col-md-4 my-2">
                        ...
                        >
                          ...
                          <b-input-group size="sm">
                            ...
                            <b-form-select
                              :options="getDivisionById(form.s_country_id)"
                              @change="dropChange2('division')"
                              v-model="$v.form.s_division_id.$model"
                              :state="validateState('s_division_id')"
                              value-field="id"
                              size="sm"
                              text-field="name"
                            >
                            ...
                            <b-form-invalid-feedback
                              v-if="!$v.form.s_division_id.required"
                            >
                              {{ $t("message.checkout.division_required") }}
                            </b-form-invalid-feedback>
                          </b-input-group>
                      ...
                      <div class="col-md-4 my-2">
                        ...
                        >
                          ...
                          <b-input-group size="sm">
                            ...
                            <b-form-select
                              :options="getCityById(form.s_division_id)"
                              v-model="$v.form.s_city_id.$model"
                              :state="validateState('s_city_id')"
                              value-field="id"
                              size="sm"
                              text-field="name"
                            >
                            ...
                            <b-form-invalid-feedback
                              v-if="!$v.form.s_city_id.required"
                            >
                              {{ $t("message.checkout.city_required") }}
                            </b-form-invalid-feedback>
                          </b-input-group>
                      ...
                      <div class="col-md-4 my-2">
                        ...
                        >
                          ...
                          <b-input-group size="sm">
                            ...
                            <b-form-input
                              v-model.number="$v.form.s_zip.$model"
                              type="number"
                              id="zip"
                              size="sm"
                              :state="validateState('s_zip')"
                              :placeholder="$t('message.checkout.zip_code')"
                            ></b-form-input>
                            <b-form-invalid-feedback
                              v-if="!$v.form.s_zip.required"
                            >
                              {{ $t("message.checkout.zip_code_required") }}
                            </b-form-invalid-feedback>
                          </b-input-group>
...
export default {
  ...
  methods: {
    ...
    shurjopay(transaction_id) {
      let total_amount =
        this.getSubTotal + this.totalTax + this.totalShippingCost;
