...
export default {
  ...
  created() {
    this.form.name=this.factory.name;
    this.form.factory_space=this.factory.factory_space;
    this.form.staff_number_id=this.factory.staff_number_id;
    this.form.rnd_staff_id=this.factory.rnd_staff_id;
    this.form.production_line_id=this.factory.production_line_id;
    this.form.annual_output_id=this.factory.annual_output_id;
  },
  methods: {
    validateState(name){
    ...
    submit() {
      ...
      this.form.put(`company/factory/info/update${this.factory.id}`)
          .then((response) => {
