                      ...
                      <div class="cat-wrapper">
                        <div class="row">
                          ...
                          <div class="col-sm-5" style="border-left: 1px solid #ddd;">
                            <div class="cat-2">
                              <img :src="showImage('verified.png')" width="50%" height="60px" alt="verified" />
                ...
                <div class="item-box">
                  ...
                  <div class="caption">
                    <div class="product-title">
                      <h6 @click="companyProfilePage(product.company_basic_info)" title="Fila Exolize 2">{{ product.company_basic_info.name }} <img :src="showImage('verified.png')" width="30%" height="25px" alt="verified" />
                      </h6>
                    </div>
...
export default {
  ...
  methods: {
    ...
    * */
    ...
    verifiedSupplier(){
      ApiService.get('verified/suppliers').then((response)=>{
